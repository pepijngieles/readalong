...
?>
	<dialog id=settings class="dialog-sheet settings<?= $settingsReader ? ' reader' : '' ?>"<?php if ($settingsCatalog): ?> aria-labelledby=settings-title<?php else: ?> aria-label="<?= e(t('nav.settings')) ?>"<?php endif; ?>>
		<div class=panel>
...
<?php endif; ?>
			<form name=settings class="content grid <?= $settingsReader ? 'gap-small' : 'gap-medium' ?>" data-input=updateSettings data-change=updateSettings>
<?php if ($settingsCatalog): ?>
...
<?php if ($settingsReader): ?>
				...
				<div class="settings-sliders grid gap-small">
...
<?php endif; ?>
				<div class="settings-look flex columns gap-medium">
				<fieldset class="settings-segment settings-appearance flex gap-xs">
					...
					<label>
						...
						<span class=button>
							...
							<span class="label<?= $settingsReader ? ' visually-hidden' : '' ?>"><?= e(t('settings.system')) ?></span>
						</span>
					</label>
					<label>
						...
						<span class=button>
							...
							<span class="label<?= $settingsReader ? ' visually-hidden' : '' ?>"><?= e(t('settings.light')) ?></span>
						</span>
					</label>
					<label>
						...
						<span class=button>
							...
							<span class="label<?= $settingsReader ? ' visually-hidden' : '' ?>"><?= e(t('settings.dark')) ?></span>
						</span>
					</label>
				</fieldset>
